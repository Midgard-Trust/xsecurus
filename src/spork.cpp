...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_17_DEVWALLET) r = SPORK_17_DEVWALLET_DEFAULT;
        if (nSporkID == SPORK_18_DEVWALLET2) r = SPORK_18_DEVWALLET2_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_17_DEVWALLET") return SPORK_17_DEVWALLET;
    if (strName == "SPORK_18_DEVWALLET2") return SPORK_18_DEVWALLET2;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_17_DEVWALLET) return "SPORK_17_DEVWALLET";
    if (id == SPORK_18_DEVWALLET2) return "SPORK_18_DEVWALLET2";
